...
class StableDiffusionInpaintPipelineTryOn(StableDiffusionInpaintPipeline):
    ...
    def __call__(
        ...
        cloth_embed: Optional[torch.FloatTensor] = None,
        sa_hidden_states: Optional[dict] = None
    ):
        r"""
        ...
        cloth_embeds = torch.cat([cloth_embed, cloth_embed])
        
        prompt_embeds = torch.cat([prompt_embeds, cloth_embeds], dim=1)
